export default {
    root: ({ props }) => ({
        class: ['shadow-xs', { 'opacity-60 select-none pointer-events-none cursor-default': props.disabled }]
    }),
    button: ({ context }) => ({
        class: [
            'relative',
            ...
            // States
            'focus:outline-hidden focus:outline-offset-0 focus:ring-primary-500 dark:focus:ring-primary-400 focus:z-10',
