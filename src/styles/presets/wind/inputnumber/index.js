    ...
    input: {
        root: ({ parent }) => ({
            class: [
                ...
                // States
                'outline-hidden focus:ring-primary-600 dark:focus:ring-primary-500',
                'focus:outline-hidden focus:outline-offset-0 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:focus:ring-primary-500',
